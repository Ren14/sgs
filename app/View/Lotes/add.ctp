...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<legend><?php echo __('Nuevo Lote'); ?></legend>
	</div>
	...
	<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
		<div class='form-group'>
			<?php
			echo $this->Form->input('socio_id', array('class' => 'form-control', 'empty' => '- Seleccionar Socio -', 'label' => 'Socio *'));
			?>
		</div>
	</div>
	<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
		<div class="form-group">
			<div class="input text required">
				...
				<input name="data[Lote][fecha_adquisicion]" class="form-control" type="date" id="LoteFechaAdquisicion" required="required">
			</div>			
		</div>
	</div>
	<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
